import { StartupBusinessesPanel } from '@/components/startups/StartupBusinessesPanel';
 ...
 * 참여 사업·프로젝트를 표시만 한다 — 매핑·신규생성·연동해제는 제공하지 않는다.
 * 매핑 편집은 각 상대 도메인 상세(사업·프로젝트의 '참여/매칭 스타트업' 카드)에서 한다.
...
export function StartupRelatedBlocks({
  ...
  return (
    <>
      {sections.businesses ? <StartupBusinessesPanel startupId={startupId} /> : null}
