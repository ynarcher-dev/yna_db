import { z } from 'zod';
import { BUSINESS_STATUS_VALUES, BUSINESS_CLASSIFICATION_VALUES } from '@/lib/labels';
...
export const businessSchema = z
  .object({
    ...
    classification: z.enum(BUSINESS_CLASSIFICATION_VALUES, {
      errorMap: () => ({ message: '구분을 선택해 주세요.' }),
    }),
